...
| --- | --- |
| `nano-ui-sdl-demo` | A tour of the widgets and charts. `--selftest` renders into a hidden window and exits. |
...
The terminal is kept small on purpose: 80 by 24 cells, UTF-8, the 16 ANSI
colours with bold and inverse, basic cursor movement and erasing, and 2,000
lines of scrollback. It advertises `TERM=ansi` and has no wide-character
layout or full VT100 support.
