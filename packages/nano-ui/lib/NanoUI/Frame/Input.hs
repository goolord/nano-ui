...
-- | The pointer and keyboard steps that 'NanoUI.Frame.runFrame' runs around
...
-- group's id ('NanoUI.Widgets.Node.tagContainer') and keeps its selected
-- index in that slot.
...
-- It repeats the test of 'NanoUI.Widgets.Node.resolveInteraction': the widget
