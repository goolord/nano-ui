...
-- ('NanoUI.Context.pointerBlockedByModal').
...
-- 'NanoUI.Frame.Scroll.applyScrollOffsets' has run.
...
-- its own, as before 'NanoUI.Frame.Scroll.applyScrollOffsets' has run in a
...
-- it is not set until 'NanoUI.Frame.Scroll.applyScrollOffsets' runs.
