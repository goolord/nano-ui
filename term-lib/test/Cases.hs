...
glyphIconTexts icons =
  [ iconChecked icons, iconUnchecked icons, iconClose icons, iconSelectOpen icons
  , iconSelectClosed icons, iconScrollUp icons, iconScrollDown icons, iconWindowTitle icons, iconModalTitle icons
  ]
